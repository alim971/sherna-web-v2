...
<script type="text/javascript">
    ...
    @else
        var reservationarea              =  "{{\App\Setting::where('name', 'duration')->first()}}";
        var durationforedit              = "{{\App\Setting::where('name', 'duration')->first()}}";
        var maxeventduration             = "{{\App\Setting::where('name', 'duration')->first()}}";
    @endif
</script>
