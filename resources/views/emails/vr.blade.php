@component('mail::message')
    ...
    {{$user->name}} právě vytvoril rezervaciu na webové stránce *{{ config('app.name') }}* (`{{ config('app.url') }}`),
    a poziadal o VR. Napis mu email na {{$user->email}} na potvrdenie VR rezervacie, a informacii o predani klucov.
